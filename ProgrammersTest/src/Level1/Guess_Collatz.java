...
public class Guess_Collatz {
    ...
    public static void main(String[] args) {
        System.out.println("Return: "+solution(6)+", 기댓값: 8");
        System.out.println("Return: "+solution(16)+", 기댓값: 4");
        System.out.println("Return: "+solution(626331)+", 기댓값: -1");
    }
}
