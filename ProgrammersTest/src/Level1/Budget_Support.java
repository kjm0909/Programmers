/*
* 문제 설명
S 사에서는 각 부서에 필요한 물품을 지원해 주기 위해 부서별로 물품을 구매하는데 필요한 금액을 조사했습니다.
...
public class Budget_Support {
    ...
    public static void main(String[] args) {
        int[] d_A = {1,3,2,5,4};
        System.out.println("Return : "+solution(d_A, 9)+", 기대값: 3");
        int[] d_B = {2,2,3,3};
        System.out.println("Return : "+solution(d_B, 10)+", 기대값: 4");
